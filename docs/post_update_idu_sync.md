...
日期：2026-09-17。当前分支：`ub-address-dependency-experiment`。来源：master `a4d355f`。
...
- Python unittest：241/241 通过，启用本分支 Native 对照。
- Native CTest：7/7。
...
- Native 对照 runner 为 `vfsim_membar_canonical_test_runner`。
